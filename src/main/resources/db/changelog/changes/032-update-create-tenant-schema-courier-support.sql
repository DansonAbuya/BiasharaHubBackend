-- Update create_tenant_schema so new tenants get courier support:
-- users role CHECK includes assistant_admin and courier; shipments includes assigned_courier_id.
